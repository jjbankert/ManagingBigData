-- Outputs the amount of country codes in the data set
...
groups = FOREACH data GENERATE country;
dist = DISTINCT groups;
numCountries = FOREACH (GROUP dist ALL) GENERATE COUNT(dist);
STORE numCountries INTO 'numCountries';
